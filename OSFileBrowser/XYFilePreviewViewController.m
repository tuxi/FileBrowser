...
@interface XYFilePreviewViewController ()

@end


#pragma mark *** XYFilePreviewViewController ***



@implementation XYFilePreviewViewController
...
- (void)loadFileWithItem:(XYFileAttributeItem *)item {
