...
typedef NS_ENUM(NSInteger, XYFileAttributeItemStatus) {
    /// 默认状态
    XYFileAttributeItemStatusDefault,
    /// 编辑状态
    XYFileAttributeItemStatusEdit,
    /// 被标记状态
    XYFileAttributeItemStatusChecked
};

@interface XYFileAttributeItem : XYFile

@property (nonatomic, assign) XYFileAttributeItemStatus status;
