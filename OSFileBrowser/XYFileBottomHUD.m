...
@interface XYFileBottomHUDViewController : UIViewController

@end

@implementation XYFileBottomHUDViewController
...
@interface XYFileBottomHUDButton : UIButton
...
@interface XYFileBottomHUD ()

@property (nonatomic, strong) UIWindow *xy_parentWindow;
@property (nonatomic, assign) CGRect hideRect;
@property (nonatomic, weak) UIView *toView;
@property (nonatomic, strong) NSArray<XYFileBottomHUDItem *> *items;
@property (nonatomic, strong) NSArray<UIButton *> *buttons;

@end

@implementation XYFileBottomHUD
...
- (void)commonInit {
    ...
    XYFileBottomHUDViewController *vc = [[XYFileBottomHUDViewController alloc] init];
...
- (void)setupViews {
    ...
    NSInteger i = 0;
    for (XYFileBottomHUDItem *item in self.items) {
        XYFileBottomHUDButton *btn = [XYFileBottomHUDButton buttonWithType:UIButtonTypeCustom];
        item.button = btn;
...
- (void)showHUDWithFrame:(CGRect)frame completion:(void (^)(XYFileBottomHUD *))completion {
...
- (void)btnClick:(UIButton *)btn {
    if (self.delegate && [self.delegate respondsToSelector:@selector(fileBottomHUD:didClickItem:)]) {
        XYFileBottomHUDItem *item = [self.items objectAtIndex:btn.tag];
...
@implementation XYFileBottomHUDItem
...
@implementation XYFileBottomHUDButton {
